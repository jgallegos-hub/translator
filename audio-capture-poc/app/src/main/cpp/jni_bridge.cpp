...
#define LOG_TAG "AudioPocJni"
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)

using audiopoc::AudioEngine;
using audiopoc::AudioEngineConfig;
using audiopoc::RingBuffer;
...
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeCreate(
...
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeDestroy(
...
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeStartCapture(
...
JNIEXPORT void JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeStopCapture(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jboolean JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeStartPlayback(
...
JNIEXPORT void JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeStopPlayback(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
/**
 * Drain up to `dst.length` samples from the capture ring into `dst`.
 * Returns the number of samples actually drained.
 */
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeDrainCapture(
    ...
    // GetShortArrayElements may copy; for hot-path performance the production
    // app should use a DirectByteBuffer pool. For this POC we accept the copy.
    ...
    env->ReleaseShortArrayElements(dst, raw, 0);  // 0 = copy back changes
    return static_cast<jint>(drained);
}

/**
 * Enqueue `src.length` samples into the playback ring (oldest dropped on overflow).
 * Returns the number of samples written.
 */
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeWritePlayback(
    ...
    env->ReleaseShortArrayElements(src, raw, JNI_ABORT);  // read-only, discard buffer
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeCaptureLatencyMs(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativePlaybackLatencyMs(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jlong JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeCaptureOverflowCount(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jlong JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativePlaybackUnderflowCount(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeCaptureRoutedDeviceId(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativePlaybackRoutedDeviceId(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeActualSampleRateCapture(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeAudioEngine_nativeActualSampleRatePlayback(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* engine = handle_to_engine(handle);
...
JNIEXPORT jlong JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeRingBuffer_nativeCreate(
...
JNIEXPORT void JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeRingBuffer_nativeDestroy(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeRingBuffer_nativeWrite(
    JNIEnv* env, jobject /*thiz*/, jlong handle, jshortArray src) {
    auto* buf = handle_to_buffer(handle);
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeRingBuffer_nativeRead(
    JNIEnv* env, jobject /*thiz*/, jlong handle, jshortArray dst) {
    auto* buf = handle_to_buffer(handle);
...
JNIEXPORT jint JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeRingBuffer_nativeAvailable(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* buf = handle_to_buffer(handle);
...
JNIEXPORT jlong JNICALL
Java_com_travel2chicago_audiopoc_audio_NativeRingBuffer_nativeOverflowCount(
    JNIEnv* env, jobject /*thiz*/, jlong handle) {
    auto* buf = handle_to_buffer(handle);
